...
import { GetRequest, errorMessage } from '../../utils';
...
class SafetyLocation extends Component {
  ...
  next = () => {
    this.props.navigation.navigate('TourStack', { screen: 'TourSafetyCleaning' })
  }
  ...
  render() {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white'}}>
            <Header { ...this.props } title="Make location adjustments" />
                    ...
                    <View style={[{ paddingHorizontal: 1}]}>
                        ...
                        <View>
                            <View style={imageContainer}>
                                <Image source={require('../../assets/images/tour_location.jpg')} resizeMode="cover" style={imgStyle} />
                            </View>
                        </View>
                        <MyText style={[textH4Style, textGrey,textBold, { marginBottom: 15, marginTop: 15}]}>
                        Whether you’re outdoors, in a public space, or indoors in a space you own, 
                        it’s likely you'll need to make some adjustments to the format of your experience.
                        </MyText>
                        ...
                        <View style={textContainer}>
                            <View style={[flexRow, { alignItems: 'center', marginBottom: 15, }]}>
                                ...
                                If you are in public spaces, change your meeting location and the 
                                venues you visit in order to avoid crowds. Keep guests moving rather than being 
                                sedentary as the latter increases the risk for transmission.</MyText>
                            </View>
                            <View style={[flexRow, { alignItems: 'center', marginBottom: 15}]}>
                                <Icon name="ellipse" style={icon} />
                                <MyText style={[textH4Style, textGrey, {flexWrap: 'wrap', flex: 1}]}>
                                If you’re indoors, consider limiting the areas a guest can enter in your home to 
                                only the necessary spaces.</MyText>
                            </View>
                            <View style={[flexRow, { alignItems: 'center', marginBottom: 15}]}>
                                <Icon name="ellipse" style={icon} />
                                <MyText style={[textH4Style, textGrey, {flexWrap: 'wrap', flex: 1}]}>
                                If you’re indoors, consider limiting the areas a guest can enter in your home to only the necessary spaces.</MyText>
                            </View>
