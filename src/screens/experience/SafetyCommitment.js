...
class SafetyCommitment extends Component {
  ...
  render() {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white'}}>
            <Header { ...this.props } title="Your commitment" />
                    ...
                    <View style={[{ paddingHorizontal: 1}]}>
                        ...
                        <View>
                            <View style={imageContainer}>
                                <Image source={require('../../assets/images/tour_commitment.jpg')} resizeMode="cover" style={imgStyle} />
                            </View>
                        </View>
                        ...
                        <View style={textContainer}>
                            <View style={[flexRow, { alignItems: 'center', marginBottom: 15, marginTop:20}]}>
                                ...
                                I have read and understand, and agree to follow the Aura safety and cleaning guidelines 
                                and will ensure that my co-hosts do the same.</MyText>
                            </View>
                            <View style={[flexRow, { alignItems: 'center', marginBottom: 15}]}>
                                <Icon name="ellipse" style={icon} />
                                <MyText style={[textH4Style, textGrey, {flexWrap: 'wrap', flex: 1}]}>
                                I understand that I am responsible for complying with local guidelines and laws applicable to my experience, 
                                including any safety and cleaning guidelines issued by local health or other authorities.</MyText>
                            </View>
