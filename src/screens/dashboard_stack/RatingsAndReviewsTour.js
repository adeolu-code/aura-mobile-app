...
class RatingsAndReviewsTour extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: colors.white}}>
        <Header {...this.props} title="Tour Reviews & Ratings" wrapperStyles={{ paddingBottom: 5}} />
        <View style={rrHeader}>
...
const styles = StyleSheet.create({
    rrHeader: {
        position: 'absolute', backgroundColor: colors.white, paddingTop: Platform.OS === 'ios' ? 110 : 100, width: '100%', paddingHorizontal: 20, zIndex: 1
    }, 
    tabsContainer: {
...
export default RatingsAndReviewsTour;
