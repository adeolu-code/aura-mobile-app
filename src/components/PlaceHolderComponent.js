...
class PlaceHolderComponent extends Component {
  ...
  render() {
    const { textWhite, textBold, textH1Style, textExtraBold, textDarkBlue, textGrey, textH4Style, imgStyle, textUnderline } = GStyles;
    const { container, btnSection, buttonStyle, btnText, accountStyle, imgContainer } = styles;
...
const styles = StyleSheet.create({
    accountStyle: {
      ...
      imgContainer: {
        marginVertical: 70, height: 330, paddingHorizontal: 20
      },
      btnSection: {
        // paddingTop: 105,
      },
      buttonStyle: {
        borderColor: colors.orange, borderRadius: 10,
        borderWidth: 1,
