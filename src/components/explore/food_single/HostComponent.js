...
class HostComponent extends Component {
  ...
  render() {
    ...
    const imgUrl = restaurant.coverPhoto ? { uri: restaurant.coverPhoto } : require('../../../assets/images/profile.png')
    const fullName = `${restaurant.firstName} ${restaurant.lastName}`
    return (
        <View style={container}>
            ...
            <View style={contentContainer}>
                <View style={[flexRow, thumbTxtContainer]}>
                    ...
                    <MyText style={[textH3Style]}>{fullName}</MyText>
                </View>
                <View>
                    <MyText style={[textGrey, textH4Style]}>{ restaurant.email}</MyText>
                </View>
                {/* <View>
                    <MyText style={[textGrey, textH4Style]}>{ restaurant ? restaurant.description : '***'}</MyText>
                </View> */}
